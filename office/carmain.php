            ...
            <div class="box">
              <div class="box-header">
                ...
                <div class="pull-right">
                  <button class="btn btn-info btn-sm" id="btnAdd" onclick="return addMainlCost()"><i class="fa fa-plus"></i> Add Cost</button>
                </div>
              </div>
              <div class="box-body">
                <table id="table_stud" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php 
                    $arr_of_all = $obj_fetch->fetchMaintain();
                    $cnt = 1;
                    ...
                    <tr>
                      ...
                      <td><?php echo $obj_converter->toEth($key['date_ins']); ?></td>
          ...
          <div class="modal-header">
            ...
            <form name="Reg_form">
               ...
               <div class="row" id="recieveddata">
                 ...
                 <div class="col-md-6">
                   ...
                   <div class="form-group">
                     ...
                     <textarea class="form-control" name="discr"></textarea>
              ...
              <div class="modal-footer">
                <button type="button" id="btnPetReg" class="btn btn-info" onclick="return registerMaintain()" >Submit</button>
              </div>
            </form>
        </div>
      </div>
        ...
        $.post("../oop/register.oop.php",
          {
            ...
            cost:  document.forms["Reg_form"]["cost"].value,
            discr:  document.forms["Reg_form"]["discr"].value,
